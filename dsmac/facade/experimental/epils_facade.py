...
from dsmac.initial_design.default_configuration_design import DefaultConfiguration
...
from dsmac.optimizer.epils import EPILS_Solver
from dsmac.optimizer.objective import average_cost
from dsmac.optimizer.acquisition import EI, LogEI, AbstractAcquisitionFunction
from dsmac.optimizer.ei_optimization import LocalSearch
...
class EPILS(object):
    ...
    stats : Stats
    solver : EPILS_Solver
        Optimizer object, see :class:`~dsmac.optimizer.epils.EPILS_Solver`
    ...
    def get_X_y(self):
        ...
        Uses dsmac.runhistory.runhistory2epm.AbstractRunHistory2EPM.get_X_y()
