...
from dsmac.epm.gaussian_process_mcmc import GaussianProcessMCMC, GaussianProcess
from dsmac.epm.gp_base_prior import HorseshoePrior, LognormalPrior
...
class SMAC4BO(SMAC4AC):
    ...
    * The random fraction is set to ``0.08447232371720552``, it was ``0.0`` before.
    ...
    def __init__(self, model_type='gp_mcmc', **kwargs):
        """
        Constructor
        see ~dsmac.facade.smac_facade for documentation
        """
        ...
        if kwargs.get('model') is None:
            from dsmac.epm.gp_kernels import ConstantKernel, Matern, WhiteKernel, HammingKernel
