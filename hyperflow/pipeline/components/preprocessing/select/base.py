...
class SelectFromModelBase(SklearnSelectMixin, HyperFlowFeatureEngineerAlgorithm):
...
class REF_Base(SklearnSelectMixin, HyperFlowFeatureEngineerAlgorithm):
    class__ = "RFE"
    module__ = "sklearn.feature_selection"
    need_y = True
...
class SelectPercentileBase(SklearnSelectMixin, HyperFlowFeatureEngineerAlgorithm):
