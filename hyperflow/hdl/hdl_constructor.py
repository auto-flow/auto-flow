...
class HDL_Constructor(StrSignatureMixin):
    ...
    def __init__(
        ...
        hdl_bank_path: str, default=None
            ...
            ``hdl_bank_path`` is this file's path. If it is None, ``hyperflow/hdl/hdl_bank.json`` will be choosed.
        ...
        ml_task: :class:`hyperflow.utils.ml_task.MLTask`

        data_manager: :class:`hyperflow.manager.data_manager.DataManager`
